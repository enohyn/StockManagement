...
<head>
    ...
    <title>View Sales | Xoom Shop</title>
 ...
 <script src="Design_Component/assets/css/sweetalert.min.js"></script>
    <script>
        function VaidationMsg() {
            swal("Oops", "From Date Must Be Equal or Less Than To Date!", "error");
        }
        function VaidationMsg1() {
            swal("Oops", "Please Select Two Date!", "error");
        }
    </script>
</head>
<body>
...
<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li >
                <a  class="active-menu" href="ViewSalesUI.aspx">
                        ...
                        <div class="col-md-6">
                            <form role="form" runat="server">
                                <div class="form-group">
                                    ...
                                    <asp:Calendar ID="fromDateCalender"  runat="server" BackColor="White" BorderColor="Black" Font-Names="Times New Roman" Font-Size="10pt" ForeColor="Black" Height="220px" NextPrevFormat="FullMonth" Width="400px" DayNameFormat="Shortest" TitleFormat="Month">
                                    ...
                                    <asp:Calendar ID="toDateCalender"  runat="server" BackColor="White" BorderColor="Black" Font-Names="Times New Roman" Font-Size="10pt" ForeColor="Black" Height="220px" NextPrevFormat="FullMonth" Width="400px" DayNameFormat="Shortest" TitleFormat="Month">
                              ...
                              <asp:GridView ID="allSellsItemGridView"  runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" Width="604px" GridLines="Vertical" ForeColor="Black">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Sell Quantity">
                                                        <ItemTemplate>
                                                            <asp:Label Height="35px" Width="120px"  runat="server" Text='<% #Eval("SellQuantity") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
