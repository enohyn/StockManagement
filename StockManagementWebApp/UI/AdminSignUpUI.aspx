<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminSignUpUI.aspx.cs" Inherits="StockManagementWebApp.UI.AdminSignUpUI" %>
...
<head>
    ...
    <title>Admin Sign Up | Xoom Shop</title> 
        ...
        <ul class="nav" id="main-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a class="active-menu" href="AdminSignUpUI.aspx">
                        ...
                        <div class="col-md-6">
                            <form role="form" runat="server">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="signatureTextBox" runat="server" CssClass="form-control"></asp:TextBox>
