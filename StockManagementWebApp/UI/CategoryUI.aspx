...
<head>
    ...
    <title>Category Setup|Xoom Shop</title>
 ...
 <script src="Design_Component/assets/css/sweetalert.min.js"></script>
    <script>
        function VaidationMsg() {
            swal("Oops", "Category Name Shouldn't Have Integer!", "error");
        }
        ...
        <ul class="nav" id="main-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a class="active-menu" href="CategoryUI.aspx">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form role="form" runat="server">
                                ...
                                <asp:Button ID="addCategoryButton" runat="server" class="btn btn-primary" Text="Save Category" OnClick="addCategoryButton_Click"/>
                                <br/>
                                <br/>
                                ...
                                <div class="col-md-6">
                                    <br/>
                                            ...
                                            <asp:GridView ID="allCategoryGridView"  runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" Width="604px" GridLines="Vertical" ForeColor="Black">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Category Name">
                                                        <ItemTemplate>
                                                            <asp:Label Height="35px" Width="120px"  runat="server" Text='<% #Eval("CategoryName") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                     <asp:TemplateField HeaderText="Update">
                                                        <ItemTemplate>
                                                            <asp:LinkButton Height="35px" Width="100px" class="btn btn-primary" runat="server" OnClick="updateCategoryLinkButton_Click">Update</asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
