<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchAndViewItemUI.aspx.cs" Inherits="StockManagementWebApp.UI.SearchAndViewItemUI" %>
...
<head>
    ...
    <title>Search & View | Xoom Shop</title>
...
<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li >
                <a  class="active-menu" href="SearchAndViewItemUI.aspx">
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                   To See You may select only company or only category name or both. 
                        ...
                        <div class="col-md-6">
                            <form role="form" runat="server">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="companyNameDropDownList" class="form-control" runat="server"></asp:DropDownList>
                                     <asp:Label ID="Label4" runat="server" Text="Category Name :"></asp:Label> 
                                    <asp:DropDownList ID="CategoryNameDropDownList" class="form-control" runat="server"></asp:DropDownList>
                                         ...
                                         <asp:GridView ID="allItemGridView"  runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" Width="604px" GridLines="Vertical" ForeColor="Black">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Quantity">
                                                        <ItemTemplate>
                                                            <asp:Label Height="35px" Width="120px"  runat="server" Text='<% #Eval("AvailableQuantity") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="ReorderLevel">
                                                        <ItemTemplate>
                                                            <asp:Label Height="35px" Width="120px"  runat="server" Text='<% #Eval("ReorderLevel") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
